...
import { earlyLearning, galleryPhoto, programs } from "@/lib/content";
...
const programPhotos = [galleryPhoto("eating"), galleryPhoto("playroom"), galleryPhoto("kitchens")] as const;
